...
export default function Footer({ className = '' }: FooterProps) {
  ...
  const privacyContent = (
    <div className="text-sm text-gray-600 space-y-2">
      ...
      <ul className="list-disc pl-5 space-y-1">
        <li>Data Collection – We may collect input text and usage data to improve performance. We do not store personal information.</li>
        <li>Third-Party Services – Our app may interact with external APIs, but we do not share identifiable user data.</li>
        <li>Cookies – We may use cookies or local storage for app functionality.</li>
        <li>Your Rights – You can stop using the app at any time. Contact us for data inquiries.</li>
        <li>What We Collect – We may collect basic usage data, such as queries or interactions, to improve app functionality. However, we do not collect personally identifiable information.</li>
        ...
        <li>Your Choices – You can stop using the app at any time. If you have concerns about data usage, you can contact us.</li>
      </ul>
    ...
    <footer className={`w-full py-2 text-center ${className}`}>
      <div className="relative">
        ...
        {(activePanel === 'tos' || activePanel === 'privacy') && (
          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-96 max-h-96 overflow-y-auto bg-white border border-gray-200 rounded-lg shadow-lg p-4">
